...
main{position:relative;max-width:min(1280px,calc(100vw - 32px));margin:0 auto}
...
<section class="panel"><div class="toolbar"><input id="memberSearch" placeholder="Search members" autocomplete="off"/><button id="exportMembers">Export CSV</button></div><div class="grid"><table id="membersTable"><thead><tr><th data-sort="name">Name</th><th data-sort="type">Type</th><th data-sort="guestOf">Guest of</th><th data-sort="email">Email</th><th data-sort="phone">Phone</th><th data-sort="wantsTableReservation">Request</th><th data-sort="table">Table</th><th data-sort="checkedIn">In</th><th data-sort="submittedAt">Submitted</th></tr></thead><tbody></tbody></table></div></section>
</div>
